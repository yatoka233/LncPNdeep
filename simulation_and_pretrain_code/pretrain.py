...
if __name__ == '__main__':
    ...
    argp.add_argument('--writing_params_path',
        help="Path to save the model after pretraining/finetuning", default="weights/pretrain/Longformer.pretrain")
    ## data argument
    ...
    if args.reading_params_path is None:
        train_config = trainer.TrainerConfig(max_epochs=20, batch_size=16, learning_rate=6e-5, lr_decay=True,
