...
if __name__ == '__main__':
    ...
    argp.add_argument('--reading_params_path',
        ...
        default="/root/autodl-tmp/weights/pretrain/save.bigbird_full.pretrain.epoch20.params")
    ## data argument
    argp.add_argument('--Pretrain_path', default="/root/autodl-tmp/data/kmer1/pre_valid_kmer1.txt")
    
    multi_type = "Ensembl"
    name = "Nomascus_leucogenys"
    argp.add_argument('--Test_Coding_path', default="/root/autodl-tmp/data/codingRNA/" + multi_type + "/" + name + "_codingRNA.txt.txt")
    argp.add_argument('--Test_Lnc_path', default="/root/autodl-tmp/data/lncRNA/" + multi_type + "/" + name + "_lncRNA.txt.txt")

    argp.add_argument('--outputs_path0', default="/root/autodl-tmp/data/output/multi_RNA/Bigbird768/" + multi_type + "/" + name + "_codingRNA_feature")
    argp.add_argument('--outputs_path1', default="/root/autodl-tmp/data/output/multi_RNA/Bigbird768/" + multi_type + "/" + name + "_lncRNA_feature")
