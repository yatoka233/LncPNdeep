...
if __name__ == '__main__':
    ...
    argp.add_argument('--reading_params_path',
        ...
        default="weights/pretrain/save.bigbird_full.pretrain.epoch20.params")
    ## data argument
    argp.add_argument('--Pretrain_path', default="data/kmer1/pre_valid_kmer1.txt")
    
    argp.add_argument('--Test_Coding_path', default="data/kmer1/valid_coding_kmer=1.csv")
    argp.add_argument('--Test_Lnc_path', default="data/kmer1/valid_lnc_kmer=1.csv")

    argp.add_argument('--outputs_path0', default="data/output/Bigbird768/valid_coding_feature")
    argp.add_argument('--outputs_path1', default="data/output/Bigbird768/valid_lnc_feature")
