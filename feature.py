...
class Feature_Generator:
    ...
    def feature(self):
        ...
        for it, doc in pbar0:
            seq = doc.split(',')[2:]  ## for csv dataset
            seq[0] = seq[0].strip("\"")
            seq[-1] = seq[-1].strip("\"")
...
if __name__ == '__main__':
    ...
    argp.add_argument('--reading_params_path',
        ...
        default="/root/autodl-tmp/weights/pretrain/save.Longformer.pretrain.epoch20.params")
    ## data argument
    argp.add_argument('--Pretrain_path', default="data/kmer1/pre_valid_kmer1.txt")
    
    argp.add_argument('--Test_Coding_path', default="data/kmer1/train_coding_kmer=1.csv")
    argp.add_argument('--Test_Lnc_path', default="data/kmer1/train_lnc_kmer=1.csv")

    argp.add_argument('--outputs_path0', default="data/output/Longformer256/train_coding_feature")
    argp.add_argument('--outputs_path1', default="data/output/Longformer256/train_lnc_feature")
